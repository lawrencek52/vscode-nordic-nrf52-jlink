...
| **Name**                                                                                                                              | **Quantity** |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| [Seeed Studio XIAO nRF52840 (Sense)](https://wiki.seeedstudio.com/XIAO_BLE/)                                                          | 1            |
...
Segger J-Link with a Seeed Studio XIAO nRF52840 Sense board.
...
```
cd ~/Documents
git clone https://github.com/lawrencek52/vscode-nordic-nrf52-jlink.git
```
...
```
https://github.com/lawrencek52/vscode-nordic-nrf52-jlink
```
